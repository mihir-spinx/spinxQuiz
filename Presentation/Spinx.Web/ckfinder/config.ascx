...
<%@ Import Namespace="Spinx.Web.Core.Authentication" %>
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        return UserAuth.IsAdminLogedIn();
    }
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "SPINX Inc";
        LicenseKey = "UE27-CPAQ-M8FW-CK63-QN32-XVR2-6PDC";
        ...
        HtmlExtensions = new[] { "html", "htm", "xml", "js","svg"  };
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip","svg" };
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new[] { "bmp", "gif", "jpeg", "jpg", "png", "svg" };
        type.DeniedExtensions = new string[] { };
